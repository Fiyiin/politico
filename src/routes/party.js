...
router.patch('/:id/name', checkEditParty, checkResult, auth.verifyToken, ctrlParty.editParty);
router.delete('/:id', checkResult, auth.verifyToken, ctrlParty.deleteParty);
